                            ...
                            <div class="row mb-2">
                                <div class="col-md-6 mb-2">
                                    <?php if (!empty($old['main_image'])): ?>
                                        <div class="card">
                                            <img src="<?= htmlspecialchars($old['main_image']) ?>" alt="Головне зображення" class="card-img-top">
                                            <div class="card-body">
                                                <a href="" class="btn btn-light" onclick="return confirm('Ви впевнені, що хочете видалити це зображення?')">Видалити</a>
                                            </div>
                                        </div>
                                    <?php endif; ?>
                                </div>
